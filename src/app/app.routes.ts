...
export const routes: Routes = [{path: '', redirectTo: 'schedule', pathMatch: 'full'}, {
  path: 'auth',
  ...
  children: [{path: '', component: MyScheduleComponent}, {
    path: ':id',
    resolve: {schedule: myScheduleResolver},
    component: MyScheduleDetailComponent
  },]
}, {
  path: 'admin-panel',
  canActivate: [authGuard],
  component: ScheduleTableCreatorComponent,
  children: [{path: '', redirectTo: 'teachers', pathMatch: 'full'}, {
    path: 'teachers',
